                    ...
                    <div class="mt-4">
                        ...
                        <table class="table table-sm table-borderless">
                            <tr>
                                ...
                                <td>{{ $gallery->event_category }}</td>
                            </tr>
                            <tr>
                                <td><strong>Tanggal:</strong></td>
                                <td>{{ $gallery->formatted_date }}</td>
                            </tr>
                            <tr>
                                <td><strong>Lokasi:</strong></td>
                                <td>{{ $gallery->location ?? 'Tidak diset' }}</td>
                            </tr>
                            <tr>
                                <td><strong>Dilihat:</strong></td>
                                <td>{{ $gallery->views }} kali</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body p-3">
                                <h6 class="card-title small fw-bold">{{ $related->title }}</h6>
