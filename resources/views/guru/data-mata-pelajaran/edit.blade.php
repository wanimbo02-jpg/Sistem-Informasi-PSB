...
@section('title', 'Edit Mata Pelajaran - PPDB')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 fw-bold text-dark">Edit Mata Pelajaran</h1>
            <p class="text-muted">Edit data mata pelajaran SMAN Karubaga</p>
        </div>
        <div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('guru.data-mata-pelajaran.update', $mapel->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_mapel" name="nama_mapel" 
                               value="{{ old('nama_mapel', $mapel->nama_mapel) }}" required placeholder="Contoh: Matematika">
                        @error('nama_mapel')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="code_mapel" name="code_mapel" 
                               value="{{ old('code_mapel', $mapel->code_mapel) }}" required placeholder="Contoh: MTK001">
                        @error('code_mapel')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_pengajar" name="nama_pengajar" 
                               value="{{ old('nama_pengajar', $mapel->nama_pengajar) }}" required placeholder="Contoh: Dr. Budi Santoso, M.Pd.">
                        @error('nama_pengajar')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="nip_pengajar" name="nip_pengajar" 
                               value="{{ old('nip_pengajar', $mapel->nip_pengajar) }}" required placeholder="Contoh: 198501012015031001">
                        @error('nip_pengajar')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            <div>
                                <div class="upload-preview" onclick="document.getElementById('foto_pengajar').click()">
                                    <div id="preview-container">
                                        ...
                                        <p class="text-muted small mb-0">Ganti foto</p>
                                    </div>
                                </div>
