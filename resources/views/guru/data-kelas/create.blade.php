...
@section('title', 'Tambah Kelas - PPDB')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 fw-bold text-dark">Tambah Kelas</h1>
            <p class="text-muted">Tambah data kelas baru SMAN Karubaga</p>
        </div>
        <div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('guru.data-kelas.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_kelas" name="nama_kelas" 
                               value="{{ old('nama_kelas') }}" required placeholder="Contoh: X IPA 1">
                        @error('nama_kelas')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="wali_kelas" name="wali_kelas" 
                               value="{{ old('wali_kelas') }}" required placeholder="Contoh: Dr. Budi Santoso, S.Pd.">
                        @error('wali_kelas')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="semester" name="semester" 
                               value="{{ old('semester', 'Ganjil 2025/2026') }}" required placeholder="Contoh: Ganjil 2025/2026">
                        @error('semester')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="total_siswa" name="total_siswa" 
                               value="{{ old('total_siswa') }}" required min="0" placeholder="0">
                        @error('total_siswa')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="laki_laki" name="laki_laki" 
                               value="{{ old('laki_laki') }}" required min="0" placeholder="0">
                        @error('laki_laki')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="perempuan" name="perempuan" 
                               value="{{ old('perempuan') }}" required min="0" placeholder="0">
                        @error('perempuan')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" 
                              placeholder="Deskripsi singkat tentang kelas...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <div class="text-danger small">{{ $message }}</div>
                    @enderror
                </div>
