...
@section('title', 'Cetak Data Siswa Diseleksi')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Cetak Data Siswa Diseleksi</h5>
                    <div>
                        <button onclick="window.print()" class="btn btn-primary">
                            <i class="bi bi-printer me-2"></i>Cetak
                        </button>
                        <a href="{{ route('guru.siswa-diseleksi.index') }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        <h4>LAPORAN DATA SISWA YANG SUDAH DISELEKSI</h4>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if(!empty($siswa->tanggal_diterima))
                                            @if(is_string($siswa->tanggal_diterima))
                                                {{ \Carbon\Carbon::parse($siswa->tanggal_diterima)->format('d/m/Y') }}
                                            @elseif(is_object($siswa->tanggal_diterima))
                                                {{ $siswa->tanggal_diterima->format('d/m/Y') }}
                                            @else
                                                -
                                            @endif
                                        @else
                                    ...
                                    <td class="text-center">
                                        ...
                                        $statusText = $siswa->status_seleksi;
                                        switch($siswa->status_seleksi) {
                                            ...
                                            default:
                                                $statusClass = 'info';
                                                $statusText = ucfirst($siswa->status_seleksi);
                                        }
                                        @endphp
                    ...
                    <div class="text-end mt-4">
                        <p class="text-muted">Total Data: <strong>{{ $siswaDiterima->count() }}</strong> siswa</p>
                        <p class="text-muted">Lulus seleksi SMAN Karubaga</p>
                    </div>
                </div>
            </div>
        </div>
