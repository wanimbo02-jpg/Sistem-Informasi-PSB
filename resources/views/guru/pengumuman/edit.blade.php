...
@section('title', 'Edit Pengumuman - Guru')
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <select class="form-select @error('jenis_pengumuman') is-invalid @enderror"
                            ...
                            <option value="seleksi_administrasi" {{ old('jenis_pengumuman', $pengumuman->jenis_pengumuman) == 'seleksi_administrasi' ? 'selected' : '' }}>
                                Hasil Seleksi Administrasi
                            </option>
                            <option value="pengumuman_final" {{ old('jenis_pengumuman', $pengumuman->jenis_pengumuman) == 'pengumuman_final' ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('sub_judul', $pengumuman->sub_judul) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('tahun_ajaran', $pengumuman->tahun_ajaran) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        @if($pengumuman->file)
                            <small class="text-muted d-block mt-1">
                                File saat ini: <a href="{{ asset('storage/'.$pengumuman->file) }}" target="_blank">Download</a>
                            </small>
                        @else
                    ...
                    <div class="col-12">
                        ...
                        <textarea
                               ...
                               id="isi" name="isi"
                               rows="5"
                               placeholder="Tulis isi pengumuman di sini (opsional)">{{ old('isi', $pengumuman->isi) }}</textarea>
                        @error('isi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
