...
@section('title', 'Dashboard Guru - PPDB')
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <div class="h2 mb-0 fw-bold">{{ number_format($total ?? 0) }}</div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <div class="h2 mb-0 fw-bold">{{ number_format($seleksiAdministrasi ?? 0) }}</div>
                            <small class="text-white-50">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <div class="h2 mb-0 fw-bold">
                                {{ number_format(\App\Models\Pendaftaran::where('status', 'pending')->count()) }}
                            </div>
                            <small class="text-white-50">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <div class="h2 mb-0 fw-bold">{{ number_format($diterimaAkhir ?? 0) }}</div>
                            <small class="text-white-50">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="mb-0">{{ number_format($diterimaAkhir ?? 0) }}</h3>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            @endphp
                            <h3 class="mb-0">{{ number_format($totalPendingRejected) }}</h3>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="mb-0">{{ number_format($lakiCount ?? 0) }}</h3>
                            <small class="text-muted">{{ $total > 0 ? round(($lakiCount / $total) * 100) : 0 }}%</small>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h3 class="mb-0">{{ number_format($perempuanCount ?? 0) }}</h3>
                            <small class="text-muted">{{ $total > 0 ? round(($perempuanCount / $total) * 100) : 0 }}%</small>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="mb-0">{{ number_format($hariIniCount ?? 0) }}</h2>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="mb-0">{{ number_format($bulanIniCount ?? 0) }}</h2>
                            <small class="text-muted">{{ \Carbon\Carbon::now()->locale('id')->isoFormat('MMMM YYYY') }}</small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h2 class="mb-0">{{ $jadwalCount ?? 3 }}</h2>
        ...
        <div class="col-12">
            <div class="card shadow h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="m-0 fw-bold text-primary">Grafik Pendaftaran {{ date('Y') }}</h6>
                    <div class="dropdown">
    ...
    let pendaftaranChart = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: { 
                ...
                title: {
                    display: true,
                    text: 'Grafik Pendaftaran Tahun {{ date("Y") }}'
                }
            }
        }
    });
    ...
    function updateChart(type) {
        ...
        switch(type) {
            ...
            case 'bulan':
                ...
                title = 'Grafik Pendaftaran Tahun {{ date("Y") }}';
                break;
            case 'tahun':
