...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        @if(!$visiMisi)
        <a href="{{ route('admin.visi-misi.create') }}" class="btn btn-primary px-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        @foreach($misiList as $item)
                            ...
                            <li class="d-flex align-items-start gap-2 mb-2">
                                ...
                                <span class="text-secondary" style="font-size: 0.95rem;">{{ trim($item) }}</span>
                            </li>
                            @endif
                        @endforeach
                    </ul>
    ...
    <div class="card border-0 shadow-sm p-3 d-flex flex-row justify-content-end gap-2" style="border-radius: 12px;">
        <a href="{{ route('admin.visi-misi.edit', $visiMisi->id) }}" class="btn btn-warning text-white px-4">
            <i class="bi bi-pencil-fill me-2"></i>Edit
        </a>
        <form action="{{ route('admin.visi-misi.destroy', $visiMisi->id) }}" method="POST"
