                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="judul_utama" name="judul_utama" value="{{ old('judul_utama', 'INFORMASI PPDB') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="sub_judul" name="sub_judul" value="{{ old('sub_judul', 'SMA NEGERI KARUBAGA') }}" required>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_siswa" name="nama_siswa" value="{{ old('nama_siswa') }}" placeholder="Masukkan nama siswa yang diterima">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="keterangan_siswa" name="keterangan_siswa" value="{{ old('keterangan_siswa') }}" placeholder="Contoh: Selamat atas diterimanya">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="status" name="status" required>
                                    <option value="aktif" {{ old('status') == 'aktif' ? 'selected' : '' }}>Aktif - Tampilkan ke User</option>
