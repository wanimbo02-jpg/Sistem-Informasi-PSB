...
<body>
    <div class="form-container">
        ...
        <div class="form-body">
            ...
            <form action="{{ route('siswa.data-ortu.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div>
                        ...
                        <input type="text" name="nik_ayah" class="form-control" value="{{ old('nik_ayah', $pendaftaran->nik_ayah ?? '') }}" maxlength="16" pattern="\d*" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir_ayah" class="form-control" value="{{ old('tanggal_lahir_ayah', $pendaftaran->tanggal_lahir_ayah ?? '') }}" required>
                    </div>
                    <div>
                        ...
                        <select name="pendidikan_ayah" class="form-select" required>
                            ...
                            <option value="D4" {{ old('pendidikan_ayah', $pendaftaran->pendidikan_ayah ?? '') == 'D4' ? 'selected' : '' }}>D4</option>
                ...
                <div class="row">
                    <div>
                        ...
                        <select name="pekerjaan_ayah" class="form-select" required>
                            ...
                            <option value="Pedagang" {{ old('pekerjaan_ayah', $pendaftaran->pekerjaan_ayah ?? '') == 'Pedagang' ? 'selected' : '' }}>Pedagang</option>
                            <option value="PNS" {{ old('pekerjaan_ayah', $pendaftaran->pekerjaan_ayah ?? '') == 'PNS' ? 'selected' : '' }}>PNS</option>
                            <option value="TNI" {{ old('pekerjaan_ayah', $pendaftaran->pekerjaan_ayah ?? '') == 'TNI' ? 'selected' : '' }}>TNI</option>
                            <option value="POLRI" {{ old('pekerjaan_ayah', $pendaftaran->pekerjaan_ayah ?? '') == 'POLRI' ? 'selected' : '' }}>POLRI</option>
                            ...
                            <option value="Sopir" {{ old('pekerjaan_ayah', $pendaftaran->pekerjaan_ayah ?? '') == 'Sopir' ? 'selected' : '' }}>Sopir</option>
                            <option value="Tukang" {{ old('pekerjaan_ayah', $pendaftaran->pekerjaan_ayah ?? '') == 'Tukang' ? 'selected' : '' }}>Tukang</option>
                            <option value="Guru" {{ old('pekerjaan_ayah', $pendaftaran->pekerjaan_ayah ?? '') == 'Guru' ? 'selected' : '' }}>Guru</option>
                            <option value="Dosen" {{ old('pekerjaan_ayah', $pendaftaran->pekerjaan_ayah ?? '') == 'Dosen' ? 'selected' : '' }}>Dosen</option>
                            <option value="Dokter" {{ old('pekerjaan_ayah', $pendaftaran->pekerjaan_ayah ?? '') == 'Dokter' ? 'selected' : '' }}>Dokter</option>
                            <option value="Perawat" {{ old('pekerjaan_ayah', $pendaftaran->pekerjaan_ayah ?? '') == 'Perawat' ? 'selected' : '' }}>Perawat</option>
                    ...
                    <div>
                        ...
                        <select name="penghasilan_ayah" class="form-select" required>
                            ...
                            <option value="lainnya" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'lainnya' ? 'selected' : '' }}>lainnya</option>
                            <option value=" Rp 1.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == '< Rp 1.000.000' ? 'selected' : '' }}>> Rp 1.000.000</option>
                            <option value="Rp 1.000.000 - 2.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'Rp 1.000.000 - 2.000.000' ? 'selected' : '' }}>Rp 1.000.000 - 2.000.000</option>
                            <option value="Rp 2.000.000 - 3.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'Rp 2.000.000 - 3.000.000' ? 'selected' : '' }}>Rp 2.000.000 - 3.000.000</option>
                            <option value="Rp 3.000.000 - 4.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'Rp 3.000.000 - 4.000.000' ? 'selected' : '' }}>Rp 3.000.000 - 4.000.000</option>
                            <option value="Rp 4.000.000 - 5.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'Rp 4.000.000 - 5.000.000' ? 'selected' : '' }}>Rp 4.000.000 - 5.000.000</option>
                            <option value="Rp 5.000.000 - 6.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'Rp 5.000.000 - 6.000.000' ? 'selected' : '' }}>Rp 5.000.000 - 6.000.000</option>
                            <option value="Rp 6.000.000 - 7.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'Rp 6.000.000 - 7.000.000' ? 'selected' : '' }}>Rp 6.000.000 - 7.000.000</option>
                            <option value="Rp 7.000.000 - 8.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'Rp 7.000.000 - 8.000.000' ? 'selected' : '' }}>Rp 7.000.000 - 8.000.000</option>
                            <option value="Rp 8.000.000 - 9.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'Rp 8.000.000 - 9.000.000' ? 'selected' : '' }}>Rp 8.000.000 - 9.000.000</option>
                            <option value="Rp 9.000.000 - 10.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'Rp 9.000.000 - 10.000.000' ? 'selected' : '' }}>Rp 9.000.000 - 10.000.000</option>
                            <option value="> Rp 10.000.000" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == '> Rp 10.000.000' ? 'selected' : '' }}>> Rp 10.000.000</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div>
                        ...
                        <input type="text" name="nik_ibu" class="form-control" value="{{ old('nik_ibu', $pendaftaran->nik_ibu ?? '') }}" maxlength="16" pattern="\d*" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir_ibu" class="form-control" value="{{ old('tanggal_lahir_ibu', $pendaftaran->tanggal_lahir_ibu ?? '') }}" required>
                    </div>
                    <div>
                        ...
                        <select name="pendidikan_ibu" class="form-select" required>
                            ...
                            <option value="D4" {{ old('pendidikan_ibu', $pendaftaran->pendidikan_ibu ?? '') == 'D4' ? 'selected' : '' }}>D4</option>
                ...
                <div class="row">
                    <div>
                        ...
                        <select name="pekerjaan_ibu" class="form-select" required>
                            ...
                            <option value="Pedagang" {{ old('pekerjaan_ibu', $pendaftaran->pekerjaan_ibu ?? '') == 'Pedagang' ? 'selected' : '' }}>Pedagang</option>
                            <option value="PNS" {{ old('pekerjaan_ibu', $pendaftaran->pekerjaan_ibu ?? '') == 'PNS' ? 'selected' : '' }}>PNS</option>
                            <option value="TNI" {{ old('pekerjaan_ibu', $pendaftaran->pekerjaan_ibu ?? '') == 'TNI' ? 'selected' : '' }}>TNI</option>
                            <option value="POLRI" {{ old('pekerjaan_ibu', $pendaftaran->pekerjaan_ibu ?? '') == 'POLRI' ? 'selected' : '' }}>POLRI</option>
                            ...
                            <option value="Guru" {{ old('pekerjaan_ibu', $pendaftaran->pekerjaan_ibu ?? '') == 'Guru' ? 'selected' : '' }}>Guru</option>
                            <option value="Dosen" {{ old('pekerjaan_ibu', $pendaftaran->pekerjaan_ibu ?? '') == 'Dosen' ? 'selected' : '' }}>Dosen</option>
                            <option value="Dokter" {{ old('pekerjaan_ibu', $pendaftaran->pekerjaan_ibu ?? '') == 'Dokter' ? 'selected' : '' }}>Dokter</option>
                            <option value="Perawat" {{ old('pekerjaan_ibu', $pendaftaran->pekerjaan_ibu ?? '') == 'Perawat' ? 'selected' : '' }}>Perawat</option>
                    ...
                    <div>
                        ...
                        <select name="penghasilan_ibu" class="form-select" required>
                            <option value="">-- Pilih Penghasilan --</option>
                            <option value="lainnya" {{ old('penghasilan_ayah', $pendaftaran->penghasilan_ayah ?? '') == 'lainnya' ? 'selected' : '' }}>lainnya</option>
                            <option value="< Rp 1.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == '< Rp 1.000.000' ? 'selected' : '' }}>< Rp 1.000.000</option>
                            <option value="Rp 1.000.000 - 2.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == 'Rp 1.000.000 - 2.000.000' ? 'selected' : '' }}>Rp 1.000.000 - 2.000.000</option>
                            <option value="Rp 2.000.000 - 3.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == 'Rp 2.000.000 - 3.000.000' ? 'selected' : '' }}>Rp 2.000.000 - 3.000.000</option>
                            <option value="Rp 3.000.000 - 4.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == 'Rp 3.000.000 - 4.000.000' ? 'selected' : '' }}>Rp 3.000.000 - 4.000.000</option>
                            <option value="Rp 4.000.000 - 5.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == 'Rp 4.000.000 - 5.000.000' ? 'selected' : '' }}>Rp 4.000.000 - 5.000.000</option>
                            <option value="Rp 5.000.000 - 6.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == 'Rp 5.000.000 - 6.000.000' ? 'selected' : '' }}>Rp 5.000.000 - 6.000.000</option>
                            <option value="Rp 6.000.000 - 7.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == 'Rp 6.000.000 - 7.000.000' ? 'selected' : '' }}>Rp 6.000.000 - 7.000.000</option>
                            <option value="Rp 7.000.000 - 8.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == 'Rp 7.000.000 - 8.000.000' ? 'selected' : '' }}>Rp 7.000.000 - 8.000.000</option>
                            <option value="Rp 8.000.000 - 9.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == 'Rp 8.000.000 - 9.000.000' ? 'selected' : '' }}>Rp 8.000.000 - 9.000.000</option>
                            <option value="Rp 9.000.000 - 10.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == 'Rp 9.000.000 - 10.000.000' ? 'selected' : '' }}>Rp 9.000.000 - 10.000.000</option>
                            <option value="> Rp 10.000.000" {{ old('penghasilan_ibu', $pendaftaran->penghasilan_ibu ?? '') == '> Rp 10.000.000' ? 'selected' : '' }}>> Rp 10.000.000</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="full-width">
                        ...
                        <textarea name="alamat_ortu" class="form-control" rows="3" required>{{ old('alamat_ortu', $pendaftaran->alamat_ortu ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div>
                        ...
                        <input type="text" name="kode_pos_ortu" class="form-control" value="{{ old('kode_pos_ortu', $pendaftaran->kode_pos_ortu ?? '') }}" maxlength="5" pattern="\d*" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="full-width">
                        ...
                        <div class="phone-input">
                            ...
                            <input type="text" name="no_hp_ortu" class="form-control phone-number" value="{{ old('no_hp_ortu', $pendaftaran->no_hp_ortu ?? '') }}" placeholder="" required>
                        </div>
