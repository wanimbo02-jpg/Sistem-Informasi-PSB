...
@section('title', 'Buat Profile Siswa')

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Buat Profile Siswa</h1>
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header bg-info text-white">
                    <h6 class="m-0 font-weight-bold">Form Data Diri Siswa</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('siswa.profile.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <!-- Data Pribadi -->
                        <h6 class="text-info mb-3">A. Data Pribadi</h6>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror"
                                       value="{{ old('nik') }}" maxlength="16" placeholder="16 digit">
                                @error('nik')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                       value="{{ old('tanggal_lahir') }}" max="{{ date('Y-m-d', strtotime('-10 years')) }}">
                                @error('tanggal_lahir')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="asal_sekolah" class="form-control @error('asal_sekolah') is-invalid @enderror"
                                   value="{{ old('asal_sekolah') }}" placeholder="Contoh: SMP Negeri 1 Karubaga">
                            @error('asal_sekolah')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Data Orang Tua -->
                        <h6 class="text-info mb-3">B. Data Orang Tua/Wali</h6>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="no_hp_ortu" class="form-control @error('no_hp_ortu') is-invalid @enderror"
                                   value="{{ old('no_hp_ortu') }}" placeholder="Contoh: 081234567890">
                            @error('no_hp_ortu')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="alamat_ortu" rows="3" class="form-control @error('alamat_ortu') is-invalid @enderror">{{ old('alamat_ortu') }}</textarea>
                            @error('alamat_ortu')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Foto -->
                        <h6 class="text-info mb-3">C. Upload Foto</h6>
                        ...
                        <div class="mb-3">
                            ...
                            @error('foto_siswa')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Format: JPG/PNG, Maks: 2MB. Ukuran foto disarankan 3x4.</small>
                        </div>
                        ...
                        <div class="alert alert-info">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="pernyataan">
                                    Saya menyatakan bahwa semua data yang saya isi adalah benar dan sesuai dengan dokumen asli.
                                </label>
                            </div>
                        </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="alert alert-warning">
                        ...
                        <ul class="mb-0 mt-2">
                            <li>Isi data dengan benar sesuai dokumen</li>
                            <li>NISN dan NIK akan digunakan untuk verifikasi</li>
                            <li>Data yang salah akan memperlambat proses pendaftaran</li>
                        </ul>
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Tips:</strong>
                        <ul class="mb-0 mt-2">
                            <li>Pastikan NISN dan NIK valid</li>
                            <li>Gunakan foto dengan latar merah/biru</li>
                            <li>Simpan data profile untuk keperluan pendaftaran</li>
                        </ul>
                    </div>

                    <div class="alert alert-success">
                        <i class="bi bi-check-circle"></i>
                        <strong>Manfaat Melengkapi Profile:</strong>
                        <ul class="mb-0 mt-2">
                            <li>Dapat mendaftar PPDB</li>
                            <li>Memudahkan proses verifikasi</li>
                            <li>Data tersimpan untuk pendaftaran berikutnya</li>
                        </ul>
                    </div>
                </div>
            </div>
