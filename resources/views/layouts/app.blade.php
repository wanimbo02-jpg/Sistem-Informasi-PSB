   ...
   <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #1f5368;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="tentangDropdown">
                            <li><a class="dropdown-item" href="{{ route('about.visi-misi') }}">Visi & Misi</a></li>
                            <li><a class="dropdown-item" href="{{ route('about.sejarah') }}">Sejarah</a></li>
                            <li><a class="dropdown-item" href="{{ route('about.struktur') }}">Struktur Organisasi</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-bold" href="{{ route('informasi-pendaftaran.index') }}">Informasi</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="beritaDropdown">
                            <li><a class="dropdown-item fw-semibold" href="{{ route('fasilitas.publik') }}">Fasilitas Sekolah</a></li>
                            <li><a class="dropdown-item fw-semibold" href="{{ route('gallery') }}">Gallery</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pengumumanDropdown">
                            <li><a class="dropdown-item fw-semibold" href="{{ route('hasil-seleksi') }}">Hasil Seleksi</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                ...
                <div class="ms-lg-3">
                    <a href="{{ route('login') }}" class="btn btn-primary" style="border-radius: 50px; padding: 0.5rem 1.5rem; font-weight: 600;">
