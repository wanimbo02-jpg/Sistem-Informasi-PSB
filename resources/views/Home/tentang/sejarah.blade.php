...
@section('title', 'Sejarah SMA Negeri Karubaga')
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-5 bg-light">
                                <div class="h-100 d-flex flex-column justify-content-between p-4">
                                    <img src="{{ asset('images/SMAN Karubaga.jpg') }}" alt="Gedung SMA Negeri Karubaga" class="img-fluid rounded-3 shadow-sm mb-4">
                                    <img src="{{ asset('images/komputer.jpeg') }}" alt="Suasana Belajar" class="img-fluid rounded-3 shadow-sm mb-4">
                                    <img src="{{ asset('images/baris.jpg') }}" alt="Suasana Belajar" class="img-fluid rounded-3 shadow-sm">
                                </div>
                            </div>
                        </div>
                    </div>
