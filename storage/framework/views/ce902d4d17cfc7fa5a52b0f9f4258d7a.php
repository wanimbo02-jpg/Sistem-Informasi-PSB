    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-4 space-y-3">
            ...
            <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-gray-800"><?php echo e($user->name ?? $user->nama_lengkap ?? 'Manu Yikwa'); ?></span>
            </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-gray-800"><?php echo e($user->nik ?? $user->nim ?? $user->nisn ?? '10033966'); ?></span>
            </div>
        ...
        <div class="flex-1 ml-64">
            ...
            <div class="p-8">
                ...
                <?php if($currentPage == 'seleksi-administrasi'): ?>
                            ...
                            <div class="bg-teal-50 border-l-4 border-teal-400 p-6 rounded-r-lg mb-4">
                                <div class="flex">
                                    ...
                                    <div class="ml-3 flex-1">
                                        <h4 class="text-lg font-medium text-teal-800 mb-2"><?php echo e($seleksiAdminSiswa->judul); ?></h4>
                                        <div class="text-sm text-teal-700 whitespace-pre-line mb-3"><?php echo e($seleksiAdminSiswa->isi); ?></div>
                                        <div class="text-xs text-teal-600">
                                            <i class="far fa-clock mr-1"></i>
                                            <?php echo e(\Carbon\Carbon::parse($seleksiAdminSiswa->created_at)->format('d/m/Y H:i')); ?>
            ...
            <span class="font-medium">Kembali</span>
                ...
                <?php elseif($currentPage == 'pengumuman'): ?>
                    <!-- Konten Pengumuman -->
                    <div class="bg-white rounded-2xl shadow-sm p-8 mb-6 border border-gray-100">
                        <div class="flex items-center gap-3 mb-6">
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-400 p-6 rounded-r-lg mb-4">
                            <div class="flex">
                                ...
                                <div class="ml-3 flex-1">
                                    <h4 class="text-lg font-medium text-blue-800 mb-2"><?php echo e($pengumumanSiswa->judul); ?></h4>
                                    <div class="text-sm text-blue-700 whitespace-pre-line mb-3"><?php echo e($pengumumanSiswa->isi); ?></div>
                                    <div class="text-xs text-blue-600">
                                        <i class="far fa-clock mr-1"></i>
                                        <?php echo e(\Carbon\Carbon::parse($pengumumanSiswa->created_at)->format('d/m/Y H:i')); ?>
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <h2 class="text-3xl font-bold">Halo, <?php echo e($user->name ?? $user->nama_lengkap ?? 'Manu Yikwa'); ?>!</h2>
                                </div>
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center mb-2">
             <span class="text-2xl font-bold text-blue-600"><?php echo e($progress ?? 0); ?>/2</span>
              <span class="text-gray-500">langkah selesai</span>
               </div>
                <div class="w-full bg-gray-200 rounded-full h-3">
                <div class="bg-blue-600 h-3 rounded-full" style="width: <?php echo e($progress_percent ?? 0); ?>%"></div>
            </div>
         </div>
        <!-- Data Pribadi Card - Tidak bisa diklik jika sudah diisi -->
        <?php if(isset($data_pribadi) && $data_pribadi): ?>
        ...
        <?php else: ?>
        <a href="<?php echo e(route('siswa.data-pribadi.index')); ?>" class="block mb-4 group animate-fade-in-up" style="animation-delay: 0.1s;">
        ...
        <?php if(isset($data_ortu) && $data_ortu): ?>
        ...
        <?php else: ?>
        <a href="<?php echo e(route('siswa.data-ortu.index')); ?>" class="block mb-4 group animate-fade-in-up" style="animation-delay: 0.2s;">
            <div class="border-2 border-gray-200 hover:border-blue-300 rounded-xl p-6 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 relative overflow-hidden">
        ...
        <?php else: ?>
        <a href="<?php echo e(route('siswa.berkas.index')); ?>" class="block mb-4 group animate-fade-in-up" style="animation-delay: 0.3s;">
            <div class="border-2 border-gray-200 hover:border-blue-300 rounded-xl p-6 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 relative overflow-hidden">
...
</html><?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/dashboard-siswa/indek.blade.php ENDPATH**/ ?>