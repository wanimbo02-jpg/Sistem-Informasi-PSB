<?php $__env->startSection('title', 'Fasilitas Sekolah'); ?>
...
<div class="container py-5">
    ...
    <?php if(isset($fasilitas) && $fasilitas->count() > 0): ?>
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <p class="card-text flex-grow-1"><?php echo e(Str::limit($item->deskripsi, 100)); ?></p>
                    <div class="mt-auto">
                        <a href="<?php echo e(route('fasilitas.publik.detail', $item->id)); ?>" class="btn btn-primary btn-sm w-100">
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="<?php echo e(asset('images/komputer.jpg')); ?>" class="card-img-top" alt="Lab Komputer">
                <div class="card-body d-flex flex-column">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="<?php echo e(asset('images/Laboratorium IPA.jpg')); ?>" class="card-img-top" alt="Lab IPA">
                <div class="card-body d-flex flex-column">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="<?php echo e(asset('images/perpus.jpg')); ?>" class="card-img-top" alt="Perpustakaan">
                <div class="card-body d-flex flex-column">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="<?php echo e(asset('images/olahraga.jpeg')); ?>" class="card-img-top" alt="Lapangan Olahraga">
                <div class="card-body d-flex flex-column">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="<?php echo e(asset('images/Aula.jpg')); ?>" class="card-img-top" alt="Aula">
                <div class="card-body d-flex flex-column">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                <img src="<?php echo e(asset('images/kantorguru.jpeg')); ?>" class="card-img-top" alt="Kantor Guru">
                <div class="card-body d-flex flex-column">
...
function showDetail(title, description, image) {
    ...
    var imagePath = '<?php echo e(asset("images/")); ?>' + image;
    ...
    document.getElementById('modalImage').onerror = function() {
        ...
        if (image.includes('komputer')) {
            this.src = '<?php echo e(asset("images/komputer.jpg")); ?>';
        } else if (image.includes('Laboratorium')) {
            this.src = '<?php echo e(asset("images/Laboratorium IPA.jpg")); ?>';
        } else if (image.includes('perpus')) {
            this.src = '<?php echo e(asset("images/perpus.jpg")); ?>';
        } else if (image.includes('olahraga')) {
            this.src = '<?php echo e(asset("images/olahraga.jpeg")); ?>';
        } else if (image.includes('Aula')) {
            this.src = '<?php echo e(asset("images/Aula.jpg")); ?>';
        } else if (image.includes('kantorguru')) {
            this.src = '<?php echo e(asset("images/kantorguru.jpeg")); ?>';
        } else {
            // Default fallback
            this.src = '<?php echo e(asset("images/SMAN Karubaga.jpg")); ?>';
        }
    };
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/public/berita.blade.php ENDPATH**/ ?>