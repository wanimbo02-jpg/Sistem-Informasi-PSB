...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> SMA Negeri Karubaga. Semua hak dilindungi.</p>
            <p>Email ini dikirim secara otomatis, jangan balas email ini.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/emails/verification-code.blade.php ENDPATH**/ ?>