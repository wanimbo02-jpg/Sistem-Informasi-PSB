...
<body>
    ...
    <div class="form-header" style="text-align: center;">
        ...
        <div class="form-body">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('siswa.data-pribadi.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <!-- Upload Foto -->
            ...
            <div class="file-hint" style="margin-top: 4px; font-size: 10px;">Format: JPEG, PNG (Max: 2MB)</div>
                ...
                <div class="row">
                    <div>
                        ...
                        <input type="text" name="nama_lengkap" class="form-control" value="<?php echo e(old('nama_lengkap', $pendaftaran->nama_lengkap ?? '')); ?>" required>
                    </div>
                    <div>
                        <label class="form-label required">NISN</label>
                        <input type="text" name="nisn" class="form-control" value="<?php echo e(old('nisn', $user->nisn ?? '')); ?>" maxlength="10" pattern="\d*" required>
                ...
                <div class="row">
                    <div>
                        ...
                        <input type="date" name="tanggal_pendaftaran" class="form-control" value="<?php echo e(old('tanggal_pendaftaran', $pendaftaran->tanggal_pendaftaran ?? date('Y-m-d'))); ?>" required>
                    </div>
                    <div>
                        <label class="form-label required">Jenis Kelamin</label>
                        <div class="radio-group">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis_kelamin" id="lk" value="L" <?php echo e(old('jenis_kelamin', $pendaftaran->jenis_kelamin ?? '') == 'L' ? 'checked' : ''); ?> required>
                                <label class="form-check-label" for="lk">Laki-laki</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis_kelamin" id="pr" value="P" <?php echo e(old('jenis_kelamin', $pendaftaran->jenis_kelamin ?? '') == 'P' ? 'checked' : ''); ?> required>
                ...
                <div class="row">
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir" class="form-control" value="<?php echo e(old('tanggal_lahir', $pendaftaran->tanggal_lahir ?? '')); ?>" required>
                    </div>
                    <div>
                        <label class="form-label required">Tempat Lahir</label>
                        <input type="text" name="tempat_lahir" class="form-control" value="<?php echo e(old('tempat_lahir', $pendaftaran->tempat_lahir ?? '')); ?>" required>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div>
                        ...
                        <select name="penerima_kps" class="form-select">
                            ...
                            <option value="Ya" <?php echo e(old('penerima_kps') == 'Ya' ? 'selected' : ''); ?>>Ya</option>
                            <option value="Tidak" <?php echo e(old('penerima_kps') == 'Tidak' ? 'selected' : ''); ?>>Tidak</option>
                        </select>
                    </div>
                    <div>
                        <label class="form-label">Nomor KPS</label>
                        <input type="text" name="nomor_kps" class="form-control" value="<?php echo e(old('nomor_kps')); ?>">
                    </div>
                </div>
                <!-- Alamat -->
                <div class="section-title">
                ...
                <div class="row">
                    <div class="full-width">
                        ...
                        <textarea name="alamat" class="form-control" rows="2" required><?php echo e(old('alamat', $pendaftaran->alamat ?? '')); ?></textarea>
                    </div>
                </div>
                <div class="info-note">
                ...
                <div class="row">
                    <div>
                        ...
                        <input type="text" name="kelurahan_desa" class="form-control" value="<?php echo e(old('kelurahan_desa', $pendaftaran->kelurahan_desa ?? '')); ?>" required>
                    </div>
                     <!-- <div class="row"> -->
              <div>
...
<div class="row">
    ...
    <div class="info-note">
      <i class="fas fa-info-circle"></i>
            Pilih provinsi untuk menampilkan kabupaten
                ...
                <div class="row">
                    <!-- <div>
                        ...
                        <input type="text" name="kode_pos" class="form-control" value="<?php echo e(old('kode_pos', $pendaftaran->kode_pos ?? '')); ?>" required>
                    </div> -->
                    <div></div>
                </div>
                <!-- Kontak -->
                ...
                <div class="row">
                    <div>
                        ...
                        <input type="text" name="telepon_rumah" class="form-control" value="<?php echo e(old('telepon_rumah')); ?>">
                    </div>
                    <div>
                        <label class="form-label required">No. HP/WA Aktif</label>
                        <input type="text" name="handphone" class="form-control" value="<?php echo e(old('handphone', $pendaftaran->handphone ?? '')); ?>" required>
                ...
                <!-- <div class="row">
                    <div>
                        ...
                        <select name="kebutuhan_khusus" class="form-select">
                            <option value="">-- Pilih Status --</option>
                            <option value="Tidak Ada" <?php echo e(old('kebutuhan_khusus') == 'Tidak Ada' ? 'selected' : ''); ?>>Tidak Ada</option>
                            <option value="Netra" <?php echo e(old('kebutuhan_khusus') == 'Netra' ? 'selected' : ''); ?>>Netra</option>
                            <option value="Rungu" <?php echo e(old('kebutuhan_khusus') == 'Rungu' ? 'selected' : ''); ?>>Rungu</option>
                            <option value="Fisik" <?php echo e(old('kebutuhan_khusus') == 'Fisik' ? 'selected' : ''); ?>>Fisik</option>
                        </select>
                    </div>
        ...
        <input type="text" name="hobi" class="form-control" value="<?php echo e(old('hobi')); ?>">
    </div>
    <div></div>
</div>
...
unset($__errorArgs, $__bag); ?>" 
            value="<?php echo e(old('tahun_lulus', $pendaftaran->tahun_lulus ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
 ...
 <div class="row">
    <div class="full-width">
        ...
        <input type="text" name="nama_kabupaten_domisili" class="form-control" value="<?php echo e(old('nama_kabupaten_domisili')); ?>">
         </div>
           </div>
                <!-- Tombol Submit -->
                <!-- Tombol Submit -->
...
</html><?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/siswa/data-pribadi/data-pribadi.blade.php ENDPATH**/ ?>