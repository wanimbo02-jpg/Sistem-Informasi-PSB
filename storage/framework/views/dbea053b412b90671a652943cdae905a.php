            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="aboutDropdown">
                        <li><a class="dropdown-item fw-bold" href="<?php echo e(route('about.sejarah')); ?>" style="font-weight: 700 !important;">Sejarah</a></li>
                        <li><a class="dropdown-item fw-bold" href="<?php echo e(route('about.visi-misi')); ?>" style="font-weight: 700 !important;">Visi Misi</a></li>
                        <li><a class="dropdown-item fw-bold" href="<?php echo e(route('about.struktur')); ?>" style="font-weight: 700 !important;">Struktur Organisasi</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('informasi-pendaftaran.index')); ?>">Informasi</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="beritaDropdown">
                        <li>
                            <a class="dropdown-item fw-bold" href="<?php echo e(route('fasilitas.publik')); ?>" style="font-weight: 700 !important;">Fasilitas Sekolah</a>
                        </li>
                        <li>
                            <a class="dropdown-item fw-bold" href="<?php echo e(route('gallery')); ?>" style="font-weight: 700 !important;">Gallery</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="pengumumanDropdown">
                        <li><a class="dropdown-item fw-bold" href="<?php echo e(route('hasil-seleksi')); ?>" style="font-weight: 700 !important;">Hasil Seleksi</a></li>
                    </ul>
                </li>
                <li class="nav-item">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?php echo e(route('informasi-pendaftaran.index')); ?>">Informasi</a></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <h5>Link Penting</h5>
                <ul class="footer-links">
                    <li><a href="<?php echo e(route('login')); ?>">Login Siswa</a></li>
                    <li><a href="<?php echo e(route('register')); ?>">Pendaftaran</a></li>
...
<?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/layouts/public-home.blade.php ENDPATH**/ ?>