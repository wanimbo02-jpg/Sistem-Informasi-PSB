    ...
    <ul class="list-unstyled components">
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="pendaftaranSubmenu">
                <li>
                    <a href="<?php echo e(route('guru.data-siswa.index')); ?>" class="submenu-link">
                        <i class="bi bi-people"></i> Data Siswa
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('guru.data-guru.index')); ?>" class="submenu-link">
                        <i class="bi bi-person-badge"></i> Data Guru
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('guru.data-orang-tua.index')); ?>" class="submenu-link">
          ...
          <li>
            ...
            <ul class="collapse list-unstyled" id="seleksiSubmenu">
                <li>
                    <a href="<?php echo e(route('guru.seleksi-administrasi.index')); ?>" class="submenu-link">
                        <i class="bi bi-funnel"></i> Seleksi Administrasi
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('guru.siswa-diseleksi.index')); ?>" class="submenu-link">
                        <i class="bi bi-check2-circle"></i> Siswa yang sudah diseleksi
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('guru.pengumuman.index')); ?>" class="submenu-link">
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="kelasMkSubmenu">
                <li>
                    <a href="<?php echo e(route('guru.data-kelas.index')); ?>" class="submenu-link">
                        <i class="bi bi-building"></i> Data Kelas
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('guru.data-mata-pelajaran.index')); ?>" class="submenu-link">
        ...
        <!-- <li>
            ...
            <ul class="collapse list-unstyled" id="masterDataSubmenu"> -->
                <!-- <li>
                    <a href="<?php echo e(route('admin.pendaftaran.index')); ?>" class="submenu-link">
...
</script><?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/guru/layouts/sidebar.blade.php ENDPATH**/ ?>