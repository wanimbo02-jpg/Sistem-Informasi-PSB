...
<head>
    ...
    <title><?php echo e($title); ?> - Penerimaan Peserta Didik Baru</title>
...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <ul class="dropdown-menu" aria-labelledby="tentangDropdown">
        <li>
            <a class="dropdown-item fw-semibold" href="<?php echo e(route('about.sejarah')); ?>">
                Sejarah
            </a>
        </li>
        <li>
            <a class="dropdown-item fw-semibold" href="<?php echo e(route('about.visi-misi')); ?>">
                Visi & Misi
            </a>
        </li>
        <li>
            <a class="dropdown-item fw-semibold" href="<?php echo e(route('about.struktur')); ?>">
                Struktur Organisasi
            </a>
              </li>
               </ul>
                ...
                <li class="nav-item">
                    <a class="nav-link fw-bold" href="<?php echo e(route('info')); ?>">Informasi</a>
                </li>
                <li class="nav-item dropdown">
   ...
   <ul class="dropdown-menu" aria-labelledby="beritaDropdown">
    <li>
        <a class="dropdown-item fw-semibold" href="<?php echo e(route('fasilitas.publik')); ?>">Fasilitas Sekolah</a>
    </li>
    <li>
        <a class="dropdown-item fw-semibold" href="<?php echo e(route('gallery')); ?>">Gallery</a>
       </li>
        </ul>
           </li>
                <li class="nav-item dropdown">
       ...
       <li>
     <a class="dropdown-item fw-semibold" href="<?php echo e(route('hasil-seleksi')); ?>">
         Hasil Seleksi
       </a>
         </li>
          </ul>
        ...
        <div class="row align-items-center min-vh-100">
            <div class="col-lg-6" data-aos="fade-right">
                <div class="hero-content">
                    ...
                    Penerimaan Peserta Didik Baru <?php echo e($tahun_ajaran); ?>
                    ...
                    <div class="hero-buttons">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-hero-primary">
                            <i class="bi bi-pencil-square me-2"></i>Daftar Sekarang
                        </a>
                        <a href="<?php echo e(route('info')); ?>" class="btn btn-hero-secondary">
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="hero-image text-center">
                    <img src="<?php echo e(asset('images/logo-sekolah.jpg')); ?>" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
...
<section class="features-section">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Informasi PPDB <?php echo e($tahun_ajaran); ?></h2>
...
<section class="cta-section">
    <div class="container">
        <div class="cta-card" data-aos="zoom-in">
            ...
            <a href="<?php echo e(route('register')); ?>" class="cta-button">
                <i class="bi bi-pencil-square me-2"></i>Daftar Sekarang
            </a>
        </div>
    </div>
...
(function() {
    ...
    const backgroundImages = [
        "<?php echo e(asset('images/Home/baris.jpg')); ?>",
        "<?php echo e(asset('images/Home/Barisan.jpg')); ?>",   // Ganti dengan file gambar Anda
        "<?php echo e(asset('images/Home/SMAN.jpeg')); ?>",   // Ganti dengan file gambar Anda
        "<?php echo e(asset('images/Home/pemberian.jpg')); ?>"    // Ganti dengan file gambar Anda
    ];
...
</html><?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/home/index.blade.php ENDPATH**/ ?>