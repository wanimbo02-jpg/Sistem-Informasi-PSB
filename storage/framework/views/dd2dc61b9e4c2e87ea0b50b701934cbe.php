...
<div class="login-card">
    ...
    <div class="card-body-custom">
        ...
        <div class="alert alert-danger alert-custom alert-dismissible fade show" role="alert">
            ...
            <?php if($errors->has('verifikasi')): ?>
                <?php echo e($errors->first('verifikasi')); ?>

                <br><a href="<?php echo e(route('verify.before.login')); ?>" class="fw-bold text-danger">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" id="loginForm" autocomplete="off">
            ...
            <div class="input-group-custom">
                ...
                <input type="text" name="nik" class="form-control-custom <?php $__errorArgs = ['nik'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="login-footer-custom">
                <a href="<?php echo e(route('register')); ?>" class="footer-link footer-link-register">
                    <i class="fas fa-user-plus"></i> Daftar Siswa Baru
                </a>
                <a href="<?php echo e(route('password.request')); ?>" class="footer-link footer-link-forgot">
...
</html><?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/auth/login.blade.php ENDPATH**/ ?>