...
<body>
    ...
    <img src="<?php echo e(asset('images/habelogo.jpg')); ?>" alt="Logo SMA Negeri Karubaga" class="logo-img"style="width: 120px; height: auto;"></div>
      <h3 class="mb-3">Verifikasi Email SMAN Karubaga</h3>
        ...
        <div class="email-display">
            ...
            <p class="mb-0 fw-bold text-primary">
                <i class="fas fa-envelope me-2"></i><?php echo e($email ?: session('verification_email') ?: 'your-email@example.com'); ?>

            </p>
        </div>
        <!-- Verification Form -->
           <form action="<?php echo e(route('verify.code')); ?>" method="POST" class="verification-form">
             <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function resendCode() {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(route('verify.resend')); ?>';
...
<?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/auth/verify-before-login.blade.php ENDPATH**/ ?>