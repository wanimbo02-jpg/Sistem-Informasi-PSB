        ...
        <div class="ms-auto d-flex align-items-center">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" style="top: 100% !important; transform: translateY(0) !important; margin-top: 0.5rem !important;">
                    <li><a class="dropdown-item" href="<?php echo e(route('admin.profile.index')); ?>"><i class="bi bi-people"></i> Profile</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('admin.pengaturan.akun')); ?>"><i class="bi bi-gear"></i> Pengaturan Akun</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
...
<?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/admin/layouts/navbar.blade.php ENDPATH**/ ?>