<?php $__env->startSection('title', 'Data Siswa - PPDB'); ?>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e(($pendaftarans->currentPage() - 1) * $pendaftarans->perPage() + $index + 1); ?></td>
                            <td><?php echo e($pendaftaran->nama_lengkap); ?></td>
                            <td>
                                <?php if($pendaftaran->foto): ?>
                                    <img src="<?php echo e(asset('uploads/foto/' . $pendaftaran->foto)); ?>" alt="Foto Siswa" style="width: 50px; height: 50px; border-radius: 50%; object-fit: cover;">
                                <?php else: ?>
                                    <div style="width: 50px; height: 50px; border-radius: 50%; background: #6c757d; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold;">
                                        <?php echo e(substr($pendaftaran->nama_lengkap, 0, 1)); ?>
                            ...
                            <td>
                                ...
                                <?php elseif($pendaftaran->jenis_kelamin == 'P'): ?>
                            ...
                            <td><?php echo e($pendaftaran->tanggal_pendaftaran ? \Carbon\Carbon::parse($pendaftaran->tanggal_pendaftaran)->format('d/m/Y') : \Carbon\Carbon::parse($pendaftaran->created_at)->format('d/m/Y')); ?></td>
                            <td>
                                <span class="status-badge status-<?php echo e($pendaftaran->status ?? 'pending'); ?>">
                                    <?php echo e(ucfirst($pendaftaran->status ?? 'pending')); ?>

                                </span>
                            </td>
                            <td>
                                <a href="<?php echo e(route('guru.data-siswa.show', $pendaftaran->id)); ?>" class="btn btn-sm btn-primary">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="<?php echo e(route('guru.data-siswa.edit', $pendaftaran->id)); ?>" class="btn btn-sm btn-warning">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form action="<?php echo e(route('guru.data-siswa.destroy', $pendaftaran->id)); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
            ...
            <div class="d-flex justify-content-end mt-3">
                <?php echo e($pendaftarans->links('pagination::custom')); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-grid gap-2">
                    <a href="<?php echo e(url('/guru/data-siswa/export/excel')); ?>" class="btn btn-outline-success">
                        <i class="bi bi-file-excel me-2"></i>Export ke Excel
                    </a>
                    <a href="<?php echo e(url('/guru/data-siswa/export/pdf')); ?>" class="btn btn-outline-danger">
                        <i class="bi bi-file-pdf me-2"></i>Export ke PDF
                    </a>
                    <a href="<?php echo e(url('/guru/data-siswa/export/print')); ?>" class="btn btn-outline-primary" target="_blank">
...
<?php echo $__env->make('guru.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\PA3\sistem_informasi_psb\sistem_informasi_psb\resources\views/guru/data-siswa/index.blade.php ENDPATH**/ ?>